...
function StatCard({
  ...
  return (
    <div
      className={`rounded-xl border border-gray-100 border-l-4 p-4 sm:p-5 transition-all hover:shadow-md ${getVariantStyles()}`}
    >
...
function CompactCard({
  ...
  return (
    <div className="flex items-center gap-3 sm:gap-4 rounded-xl border border-gray-100 bg-white p-3 sm:p-4 transition-all hover:shadow-md">
      <div className="flex h-10 w-10 sm:h-12 sm:w-12 flex-shrink-0 items-center justify-center rounded-lg bg-gray-50">
...
function FunnelChart() {
  ...
  return (
    <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-6">
      ...
      <div className="mt-6 sm:mt-8 flex justify-center gap-6 sm:gap-8 border-t border-gray-100 pt-4 sm:pt-6">
...
function ConversionCard({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 rounded-xl border border-gray-100 bg-white p-3 sm:p-4 transition-all hover:shadow-md">
      <div
      ...
      <button className="hidden sm:flex cursor-pointer items-center gap-1 rounded-lg border border-gray-200 px-3 py-1.5 text-xs font-medium text-gray-600 transition-colors hover:bg-gray-50">
...
function QrCodeCard({ title, subtitle }: { title: string; subtitle?: string }) {
  return (
    <div className="flex h-full flex-col items-center justify-between rounded-xl border border-gray-100 bg-white p-4 sm:p-6 transition-all hover:shadow-lg">
      ...
      <div className="relative mb-4 sm:mb-6 flex h-36 w-36 sm:h-48 sm:w-48 items-center justify-center rounded-xl border-2 border-gray-900 bg-white p-2">
        {/* Cantos do QR Code */}
        <div className="absolute left-2 top-2 h-6 w-6 sm:h-8 sm:w-8 border-l-[3px] sm:border-l-4 border-t-[3px] sm:border-t-4 border-gray-900"></div>
        <div className="absolute right-2 top-2 h-6 w-6 sm:h-8 sm:w-8 border-r-[3px] sm:border-r-4 border-t-[3px] sm:border-t-4 border-gray-900"></div>
        <div className="absolute bottom-2 left-2 h-6 w-6 sm:h-8 sm:w-8 border-b-[3px] sm:border-b-4 border-l-[3px] sm:border-l-4 border-gray-900"></div>
        ...
        <div className="absolute left-1/2 top-1/2 flex h-9 w-9 sm:h-12 sm:w-12 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-lg bg-orange-500 text-white shadow-sm">
...
function ResponseCard() {
  ...
  return (
    <div className="flex h-full flex-col rounded-xl border border-gray-100 bg-white p-4 sm:p-6 shadow-sm">
      <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0 border-b border-gray-100 pb-4">
        <div className="flex items-center gap-2">
          <div className="rounded-lg bg-emerald-100 p-2 text-emerald-600">
            <Smartphone className="h-5 w-5" />
          </div>
          <div>
            <h4 className="text-sm sm:text-base font-bold text-gray-900">Respostas Automáticas</h4>
            <p className="text-xs text-gray-500 hidden sm:block">Sugestão para enviar aos clientes</p>
          </div>
        </div>
        <button 
          onClick={handleCopy}
          className={`group flex cursor-pointer items-center gap-2 rounded-lg border px-3 sm:px-4 py-1.5 sm:py-2 text-xs font-semibold transition-all shadow-sm ${
            copied 
      ...
      <div className="relative flex-1 rounded-xl bg-gray-50 p-3 sm:p-4">
        {/* Navegação e Balão */}
        <div className="flex items-center gap-2">
          <button 
          ...
          <div className="flex-1 rounded-2xl rounded-tl-none bg-white p-3 sm:p-4 shadow-sm border border-gray-100 min-h-[100px] sm:min-h-[120px] flex items-center">
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-gray-500">Visão geral do seu negócio</p>
        </div>
        ...
        <div className="relative">
          <button
            ...
            className="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm font-medium text-gray-700 transition-all hover:bg-gray-50"
          >
      ...
      <div className="mt-8 sm:mt-12 border-t border-gray-100 pt-6 sm:pt-8">
        <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0">
          ...
          <div className="relative">
            ...
            >
              <Calendar className="h-4 w-4 text-gray-400" />
              <span className="hidden sm:inline">{performanceDateRange}</span>
      ...
      {/* Conversões */}
      <div>
        <h2 className="mb-3 sm:mb-4 text-base sm:text-lg font-semibold text-gray-900">Conversões</h2>
      ...
      <div className="mt-8 sm:mt-12">
        <h2 className="mb-4 sm:mb-6 text-base sm:text-lg font-semibold text-gray-900">
